 ...
 * @author Charly Ponce
 */
public class FrmIdentifier extends javax.swing.JFrame {
    ...
    private void analizeBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_analizeBtnActionPerformed
        ...
        try {
            ...
            Logger.getLogger(FrmIdentifier.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmIdentifier.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmIdentifier().setVisible(true);
            }
        });
    }
